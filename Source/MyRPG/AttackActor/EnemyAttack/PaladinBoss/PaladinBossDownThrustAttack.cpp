...
#include "PaladinBossDownThrustAttack.h"
...
void APaladinBossDownThrustAttack::BeginPlay()
{
	Super::BeginPlay();
...
void APaladinBossDownThrustAttack::OnOverlapBegin_Implementation(AActor* OtherActor)
{
...
void APaladinBossDownThrustAttack::OnOverlapEnd_Implementation(AActor* OtherActor)
{
}

void APaladinBossDownThrustAttack::OnOverlapping_Implementation(float DeltaTime)
{
}
