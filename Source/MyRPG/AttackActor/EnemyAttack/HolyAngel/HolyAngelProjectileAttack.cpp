...
#include "HolyAngelProjectileAttack.h"
...
void AHolyAngelProjectileAttack::BeginPlay()
{
	Super::BeginPlay();
...
void AHolyAngelProjectileAttack::OnOverlapBegin_Implementation(AActor* OtherActor)
{
...
void AHolyAngelProjectileAttack::OnOverlapEnd_Implementation(AActor* OtherActor)
{
}

void AHolyAngelProjectileAttack::OnOverlapping_Implementation(float DeltaTime)
{
}
